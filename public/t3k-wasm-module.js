function isMobileDevice() {
  if (ENVIRONMENT_IS_NODE || ENVIRONMENT_IS_WORKER || ENVIRONMENT_IS_AUDIO_WORKLET) {
    return false;
  }
  try {
...
var INITIAL_MEMORY = Module['INITIAL_MEMORY'] || (isMobileDevice() ? 1073741824 : 1073741824);
assert(
...
if (ENVIRONMENT_IS_PTHREAD) {
  ...
  if (Module['wasmMemory']) {
    ...
    wasmMemory = new WebAssembly.Memory({
      ...
      maximum: isMobileDevice() ? 1073741824 / 65536 : 2147483648 / 65536,
      shared: true,
    });
...
var wasmBinaryFile;
wasmBinaryFile = 't3k-wasm-module.wasm';
...
var PThread = {
  ...
  allocateUnusedWorker: function () {
    var worker;
    var pthreadMainJs = locateFile('t3k-wasm-module.worker.js');
...
function _wasmWorkerInitializeRuntime() {
  ...
  if (typeof AudioWorkletGlobalScope === 'undefined') {
    ...
    _wasmWorkerDelayedMessageQueue =
      _wasmWorkerDelayedMessageQueue.forEach(_wasmWorkerRunPostMessage);
...
function ___emscripten_init_main_thread_js(tb) {
  __emscripten_thread_init(tb, !ENVIRONMENT_IS_WORKER, 1, !ENVIRONMENT_IS_WEB, 536870912);
...
function _emscripten_create_wasm_audio_worklet_node(
  contextHandle,
  name,
  options,
  callback,
...
function _emscripten_create_wasm_audio_worklet_processor_async(
  contextHandle,
  options,
  callback,
  userData
...
function _emscripten_set_click_callback_on_thread(
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(3, 1, target, userData, useCapture, callbackfunc, targetThread);
...
function _emscripten_start_wasm_audio_worklet_thread_async(
  contextHandle,
  stackLowestAddress,
  stackSize,
  callback,
...
var wasmImports = {
  ...
  w: __emscripten_set_offscreencanvas_size,
  x: __emscripten_thread_mailbox_await,
  g: __emscripten_thread_set_strongref,
  d: _abort,
  e: _emscripten_asm_const_int,
  C: _emscripten_audio_context_state,
  z: _emscripten_check_blocking_allowed,
  i: _emscripten_create_audio_context,
  s: _emscripten_create_wasm_audio_worklet_node,
  j: _emscripten_create_wasm_audio_worklet_processor_async,
  A: _emscripten_exit_with_live_runtime,
  c: _emscripten_get_now,
  v: _emscripten_receive_on_main_thread_js,
  t: _emscripten_resize_heap,
  B: _emscripten_resume_audio_context_sync,
  k: _emscripten_set_click_callback_on_thread,
  h: _emscripten_start_wasm_audio_worklet_thread_async,
  p: _environ_get,
...
var _setDsp = (Module['_setDsp'] = function () {
  return (_setDsp = Module['_setDsp'] = Module['asm']['E']).apply(null, arguments);
});
...
var __emscripten_tls_init = (Module['__emscripten_tls_init'] = function () {
  return (__emscripten_tls_init = Module['__emscripten_tls_init'] = Module['asm']['H']).apply(
    null,
    arguments
  );
});
var _pthread_self = (Module['_pthread_self'] = function () {
  return (_pthread_self = Module['_pthread_self'] = Module['asm']['I']).apply(null, arguments);
});
var __emscripten_thread_init = (Module['__emscripten_thread_init'] = function () {
  return (__emscripten_thread_init = Module['__emscripten_thread_init'] = Module['asm']['K']).apply(
    null,
    arguments
  );
});
var ___set_thread_state = (Module['___set_thread_state'] = function () {
  return (___set_thread_state = Module['___set_thread_state'] = Module['asm']['L']).apply(
    null,
    arguments
  );
});
...
var __emscripten_run_in_main_runtime_thread_js = function () {
  return (__emscripten_run_in_main_runtime_thread_js = Module['asm']['N']).apply(null, arguments);
};
var _emscripten_dispatch_to_thread_ = function () {
  return (_emscripten_dispatch_to_thread_ = Module['asm']['O']).apply(null, arguments);
};
var __emscripten_thread_free_data = function () {
  return (__emscripten_thread_free_data = Module['asm']['P']).apply(null, arguments);
};
var __emscripten_thread_exit = (Module['__emscripten_thread_exit'] = function () {
  return (__emscripten_thread_exit = Module['__emscripten_thread_exit'] = Module['asm']['Q']).apply(
    null,
    arguments
  );
});
...
var _emscripten_stack_set_limits = function () {
  return (_emscripten_stack_set_limits = Module['asm']['S']).apply(null, arguments);
};
var _emscripten_wasm_worker_initialize = (Module['_emscripten_wasm_worker_initialize'] =
  function () {
    return (_emscripten_wasm_worker_initialize = Module['_emscripten_wasm_worker_initialize'] =
...
var dynCall_ii = (Module['dynCall_ii'] = function () {
  return (dynCall_ii = Module['dynCall_ii'] = Module['asm']['_']).apply(null, arguments);
});
var _asyncify_start_unwind = function () {
  return (_asyncify_start_unwind = Module['asm']['$']).apply(null, arguments);
};
var _asyncify_stop_unwind = function () {
  return (_asyncify_stop_unwind = Module['asm']['aa']).apply(null, arguments);
};
var _asyncify_start_rewind = function () {
  return (_asyncify_start_rewind = Module['asm']['ba']).apply(null, arguments);
};
var _asyncify_stop_rewind = function () {
  return (_asyncify_stop_rewind = Module['asm']['ca']).apply(null, arguments);
};
